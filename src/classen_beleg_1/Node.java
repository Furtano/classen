...
public class Node {
    ...
    /***
     * Adds a outgoing Link to List, checks if Link is already in List and if then do not add.
     * @param link outgoing link
     */
    ...
    /***
     * Adds a incoming Link to List, checks if Link is already in List and if then do not add.
     * @param link incoming link
     */
    ...
    public void printPageRank () {
          System.out.print(Math.round(pageRank*10000000)/10000000.0);
     ...
     * @param probability single transition probability
     */
